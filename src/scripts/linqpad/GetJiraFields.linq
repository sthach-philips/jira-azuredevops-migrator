    ...
    using (var client = new HttpClient())
    {
        ...
        if (fieldResponse.IsSuccessStatusCode)
        {
            ...
            fields.Select(f => new
            {
                ...
                PossibleValuesJson = GetPossibleValues(client, f, jiraDomain) // Pass the same authenticated HttpClient
...
string GetPossibleValues(HttpClient client, JiraField field, string baseUrl)
{
    ...
    {
        string optionsUrl = $"{baseUrl}/rest/api/3/field/{field.Id}/context";
